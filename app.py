...
def fetch_poster(movie_id):
    ...
    try:
        # Disable SSL verification due to potential SSL issues
        data = session.get(url, verify=False, timeout=10)
        ...
        # Silently handle errors and return placeholder
        pass
...
try:
    ...
    similarity_list = pickle.load(open('artifacts/similarity.pkl', 'rb'))
